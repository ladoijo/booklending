...
class ResourceNotFoundExceptionTest {
  ...
  void setUp() {
    ...
    Mockito.when(
            ms.getMessage(Mockito.anyString(), Mockito.any(), Mockito.any(Locale.class)))
  ...
  void constructor_shouldUseLanguageUtilMessageAsExceptionMessage() {
    var ex = new ResourceNotFoundException("error.resource.notfound");
    assertThat(ex.getMessage()).isEqualTo("translated:error.resource.notfound");
  }
}